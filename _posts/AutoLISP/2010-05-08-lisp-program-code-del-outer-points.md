---
title: 删除封闭区域以外地形点AutoLISP程序源代码
author: QinDong
date: 2010-05-08 13:56:10 +0800
...
本段代码是 [AutoCAD工程测量工具集](https://www.cehui.ren/posts/acad-toolkit/) 中的一个功能的源代码，可以单独运行。功能为将一封闭区域以外的地形点全部删除。
...
(defun C:zzQydx
  ...
  (princ
    "功能：删除指定区域外的点。(C)水电十二局宁海施工局测量队 覃东 2017.05 qd.xyz@139.com\n"
    )
  (setq	filename1
	 (getfiled "提示字符串"
		   "D:\\"
